...
function M.setup(opts)
    ...
    set_hl(0, "GitSignsAddLn", { fg = green, bg = bg_color })
    set_hl(0, "GitSignsAddNr", { fg = green, bg = bg_color })
    set_hl(0, "GitSignsChangeLn", { fg = yellow, bg = bg_color })
    set_hl(0, "GitSignsChangeNr", { fg = yellow, bg = bg_color })
    set_hl(0, "GitSignsDeleteLn", { fg = red, bg = bg_color })
    set_hl(0, "GitSignsDeleteNr", { fg = red, bg = bg_color })
    ...
    set_hl(0, "DiagnosticUnderlineError", { link = "Error", undercurl = true, sp = red })
    set_hl(0, "DiagnosticUnderlineWarn", { link = "Warning", underline = true, sp = yellow })
    set_hl(0, "DiagnosticUnderlineInfo", { link = "Information", underline = true, sp = blue })
    set_hl(0, "DiagnosticUnderlineHint", { link = "Hint", underline = true, sp = green })
