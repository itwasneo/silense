...
function M.setup(opts)
    ...
    -- Git
    set_hl(0, "DiffAdd", { fg = green, bold = true, sp = green })
    set_hl(0, "DiffChange", { fg = yellow, bold = true, sp = yellow })
    set_hl(0, "DiffDelete", { fg = red, bold = true })
    set_hl(0, "DiffText", { fg = blue, bold = true, sp = blue })
