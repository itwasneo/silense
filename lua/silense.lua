...
function M.setup(opts)
    ...
    set_hl(0, "DiagnosticUnderlineError", { link = "Error", undercurl = true })
    set_hl(0, "DiagnosticUnderlineWarn", { link = "Warn", underline = true })
    set_hl(0, "DiagnosticUnderlineInfo", { link = "Information", underline = true })
    set_hl(0, "DiagnosticUnderlineHint", { link = "Hint", underline = true })
